  ...
  return (
    <div className="relative flex h-screen w-full flex-col overflow-x-hidden rounded-lg border bg-background md:shadow-xl ">
      ...
      >
        ...
        <div className="relative max-w-4xl mx-auto text-center px-4 z-50">
          ...
          <ShimmerButton className="mt-5 inline-flex shadow-2xl justify-center items-center">
            <span className="whitespace-pre-wrap text-center text-sm font-medium leading-none tracking-tight text-white dark:from-white dark:to-slate-900/10 lg:text-lg z-50" onClick={() => {
